# This is a developer-friendly Dockferfile, NEVER USE FOR PRODUCTION
...
# Add to sudoers so you can install packages as necessary
...
ARG build_node_version=22.14.0
ENV NODE_VERSION=$build_node_version
ARG NVM_DIR=/home/${USER_NAME}/.nvm
ARG build_nvm_install_version=v0.40.2
...
ARG build_python_version=3.11.11
...
ARG build_app_dir=app
ENV APP_DIR=$build_app_dir
